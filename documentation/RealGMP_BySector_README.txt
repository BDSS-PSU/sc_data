...
This dataset contains the percent change in 2013 GMP for each metropolitan unit broken down by sector.
The data comes from the Bureau of Economic Analysis (download the PDF, table 3)
...
(D) values are hidden to protect confidential information
